...
class ImuProcess
{
 public:
  ...
  void Reset();
  void Reset(double start_timestamp, const LioImu::ConstPtr &lastimu);
 ...
 private:
  ...
  LioImu::ConstPtr last_imu_;
  deque<LioImu::ConstPtr> v_imu_;
...
void ImuProcess::Process(const MeasureGroup &meas,  esekfom::esekf<state_ikfom, 12, input_ikfom> &kf_state, PointCloudXYZI::Ptr cur_pcl_un_)
{
  ...
  if (imu_need_init_)
  {
    ...
    if (init_iter_num > MAX_INI_COUNT)
    {
      ...
      // No implicit files in the source tree.
    }
