...
from bindu_core.plugins import load_provider
from bindu_core.robot_io.system import RobotIO

DEFAULT_DRIVERS = {
    'joint_driver_provider': 'bindu_core.drivers.simulated_joints:SimJointDriver',
    'hand_driver_provider': 'bindu_core.drivers.simulated_hand:SimHandDriver',
    'base_driver_provider': 'bindu_core.drivers.simulated_base:SimBaseDriver',
}
